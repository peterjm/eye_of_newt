...
racc_action_table = [
   -47,    22,    19,    21,    12,    32,    20,   -47,    11,   -47,
    13,   -47,    14,    19,    12,    12,    35,    20,    38,    24,
    36,    25,    14,    19,    19,    39,    40,    20,    20,    24,
    24,    25,    25,    29,   -35,    30,    31,    12,    42,    58,
    46,    47,    30,    31,    30,    31,    44,    48,    31,    42,
    42,    59,    60,    21,    21,    63,    46,    64,    65,    31,
    31,    68,    69 ]

racc_action_check = [
    11,     1,     0,     0,     0,     4,     0,    11,     0,    11,
     0,    11,     0,     2,     6,     7,     6,     2,     8,     2,
     6,     2,     6,    18,    32,     9,     9,    18,    32,    18,
    32,    18,    32,     3,    13,     3,     3,    33,    14,    33,
    21,    21,    23,    23,    26,    26,    15,    22,    27,    30,
    31,    34,    37,    39,    40,    41,    44,    46,    47,    49,
    51,    55,    57 ]

racc_action_pointer = [
     0,     1,    11,    24,    -2,   nil,    10,    11,    12,    11,
   nil,     0,   nil,    30,    33,    43,   nil,   nil,    21,   nil,
   nil,    24,    47,    31,   nil,   nil,    33,    36,   nil,   nil,
    44,    45,    22,    33,    45,   nil,   nil,    46,   nil,    50,
